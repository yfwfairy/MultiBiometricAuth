...
import com.njupt.multibiometricauth.face.model.ItemShowInfo;
import com.njupt.multibiometricauth.face.widget.MultiFaceInfoAdapter;
...
public class PhotoRegisterAndRecognizeActivity extends FaceConfigActivity {
    ...
    private void initEngine() {
        ...
        if (faceEngineCode != ErrorInfo.MOK) {
            showToast(getString(R.string.active_failed, faceEngineCode));
        }
    }
